...
public class VideoFrame {
    ...
    private init(_ ptr : UnsafeMutablePointer<mdkVideoFrameAPI>!, ownership: Ownership) {
        frame = ptr
        self.ownership = ownership
    }

    static func retained(_ ptr: UnsafeMutablePointer<mdkVideoFrameAPI>!) -> VideoFrame? {
        guard let ptr else { return nil }
        guard let retained = mdkVideoFrameAPI_ref(ptr) else { return nil }
        return VideoFrame(retained, ownership: .unref)
    }
    ...
    public func addBuffer(data:Data, stride:Int32, plane:Int32 = 0) -> Bool {
    ...
    public func bufferData(plane:Int32 = 0) -> Data {
    ...
    public func to(format:PixelFormat, width : Int32 = -1, height:Int32 = -1) -> VideoFrame {
        ...
        return VideoFrame(p, ownership: .delete)
    }
